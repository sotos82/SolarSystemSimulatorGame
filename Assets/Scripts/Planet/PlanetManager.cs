...
public class PlanetManager : MonoBehaviour
{
	...
	private static string[] planetNames = {"Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Neptune"};
	private static string[] planetMaterials = {"Materials/MercuryMaterial", "Materials/VenusMaterial", "Materials/EarthMaterial", 
		"Materials/MarsMaterial", "Materials/JupiterMaterial", "Materials/SaturnMaterial", "Materials/UranusMaterial", "NeptuneMaterial"};
	...
	void Awake()
	{
		...
		planetParameters[0] = new float[numOfPlanetParams] {0.2056f, 0.3075f   * scaleRp,  0.241f, 0.38f, 0.01f, -0.16f   , 48.3f, 0.05527f};		//Mercury
		planetParameters[1] = new float[numOfPlanetParams] {0.0067f,  0.718f   * scaleRp,  0.615f,  0.95f, 177.4f, -0.67f  , 76.7f, 0.8145f};		//Venus
		planetParameters[2] = new float[numOfPlanetParams] {0.0167f, 0.9833f   * scaleRp,     1f,     1f,      23.45f, -0.0027f, 349f, 1f};	        //Earth
		planetParameters[3] = new float[numOfPlanetParams] {0.0934f, 1.3814f   * scaleRp, 1.882f, 0.53f, 25.19f, -0.0029f, 49.6f, 0.1075f};		    //Mars
		planetParameters[4] = new float[numOfPlanetParams] {0.0488f,   4.950f   * scaleRp,  11.86f ,   11f, 3.13f, -0.0011f , 101f, 317.828f};		//Jupiter
		planetParameters[5] = new float[numOfPlanetParams] {0.0542f,   9.021f   * scaleRp, 29.457f ,  9.14f, 26.73f, -0.0012f, 114f, 95.161f};		//Saturn
		planetParameters[6] = new float[numOfPlanetParams] {0.0472f, 18.286f   * scaleRp,  84.016f ,   4f, 97.77f, 0.0019f, 74.2f, 14.5357f};	    //Uranus
		planetParameters[7] = new float[numOfPlanetParams] {0.0086f,   29.81f   * scaleRp, 164.791f, 3.9f, 28.32f, -0.0018f,  131f, 17.1478f};		//Neptune

		const int numOfMoonParams = 8;
        moonParameters[0] = new float[numOfMoonParams] { 0.055f, 2.44f, 0.074f, 0.273f, 6.69f, -29/365f, 0.0f, 0.012f };	
