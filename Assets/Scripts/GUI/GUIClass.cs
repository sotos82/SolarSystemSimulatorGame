...
public class GUIClass : MonoBehaviour
{
    ...
    private float gravMultiplier = Scales.massScale;
    ...
    private MissileManager scManager;

    private ObjectiveManager.Objective[] objectiveList;
    ...
    void Start()
	{
        ...
        objectiveList = GetComponent<ObjectiveManager>().ObjsList;

		scManager = GameObject.Find("SpaceCraftManager").GetComponent<MissileManager>();
...
/******************************************************************************************************************/
	...
	void OnGUI ()
	{
        ...
        if (buttonStatus == Buttons.gravityButton)
        {
            ...
            {
                foreach (ObjectiveManager.Objective o in objectiveList)
                    o.isCompleted = false;
    ...
    void ShowLaunchPanel(float minDirection, float maxDirection, float minSpeed, float maxSpeed, string label)
    {
        ...
        {
            scManager.LaunchSpaceCraft(hScrollbarSpeed, hScrollbarDirection, label);
            buttonStatus = 0;
